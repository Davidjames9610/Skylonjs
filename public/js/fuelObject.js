...
class fuelObject {
    ...
    constructor() {
        ...
        //fuel empty status 
        this.lh2fwd_empty = false;
        this.lh2aft_empty = false;
        this.loxfwd_empty = false;
        this.loxaft_empty = false;

        //fuel mode: 1 for lh2, 2 for lox 
        this.mode = 1;

        //Cofg update 
        this.currentCofg = 52;      //update and return to the engineer object, send to cofgObject 
        this.desiredCofg = 52;       // from the cofgObject if I want to implement the autopilot
    ...
    ToggleLH2fwd(boolean) {
        ...
        if ((boolean == true) && (this.lh2fwd_empty == false)) {
            //switch tank on
    ...
    ToggleLH2aft(boolean) {
        ...
        if (boolean == true && (this.lh2aft_empty == false)) {
            //switch tank on
    ...
    ToggleLOXfwd(boolean) {
        ...
        if (boolean == true && (this.loxfwd_empty == false)) {
            //switch tank on
    ...
    ToggleLOXaft(boolean) {
        ...
        if (boolean == true && this.loxaft_empty == false) {
            //switch tank on
    ...
    update(time,cofgaim) {
        ...
        if (time > 585) {
            ...
            //after 585 seconds or height or speed? transition to lox...
    ...
    updateFuel(){
        this.emptyCheck();      //switch off tank if capacity is reached
    ...
    updateVariables(){
        ...
        //Aim: update the weights in the fuel tanks
    ...
    updateCofgCurrent(){
        ...
        //[1] updates the position of the current cofg for the cofg Object
        ...
        if (this.mode == 1) {
            hydrogenF_rate = 43 / 1000;
            hydrogenA_rate = -160 / 1000;
            oxygenF_rate = 0;
            oxygenA_rate = 0;
        }
        else {
            hydrogenF_rate = 60 / 1000;
            hydrogenA_rate = -60/ 1000;
            oxygenF_rate = 200 / 1000;
            oxygenA_rate = -190 / 1000;
        }

        //position the cofgCurrent 
    ...
    emptyCheck(){
     ...
     if(this.w1 <= 0){
        this.lh2fwd_empty = true;
        this.ToggleLH2fwd(false);
        console.log("lh2fwd has been switched off");
     }

     if(this.w2 <= 0){
        this.loxfwd_empty = true;
        this.ToggleLOXfwd(false);
        console.log("loxfwd has been switched off");
     }

     if(this.w3 <= 0){
        this.loxaft_empty = true;
        this.ToggleLOXaft(false);
        console.log("loxaft has been switched off");
     }

     if(this.w4 <= 0){
        this.lh2aft_empty = true;
        this.ToggleLH2aft(false);
        console.log("lh2aft has been switched off");
     }
